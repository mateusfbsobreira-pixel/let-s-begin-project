    ...
    <section className="border-t border-gold/20 bg-artisan-cream px-4 py-20">
      <div className="mx-auto max-w-7xl">
        <header className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-3 max-w-xl text-sm leading-relaxed text-artisan-ink/70">
        ...
        <div className="mt-12 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {books.map((book) => (
            <article
              key={book.title}
              className={`flex flex-col rounded-2xl bg-paper p-5 text-center shadow-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-xl ${
                book.exclusive
                  ? "border-2 border-wine/40"
                  : "border border-gold/25"
              }`}
            >
              <p
                className={`min-h-8 text-xs font-bold uppercase leading-snug ${
              ...
              <div className="flex flex-1 flex-col pt-4">
                <h3 className="font-serif text-xl font-bold leading-snug text-artisan-ink">
                  {book.title}
                </h3>
                <p className="mt-2 flex-1 text-sm leading-relaxed text-artisan-ink/65">
                  {book.subtitle}
                </p>

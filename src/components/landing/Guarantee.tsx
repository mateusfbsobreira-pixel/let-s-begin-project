    ...
    <section className="border-t border-gold-mute/10 bg-warm-white px-4 py-16">
      <div className="mx-auto max-w-3xl text-center">
        ...
        <p className="mx-auto mt-4 max-w-3xl text-base leading-relaxed text-artisan-ink/85 sm:text-lg">
          ...
          de semana. Si por cualquier motivo no estás 100% fascinado, escríbenos
          a soporte@lacasadelpanartesanal.shop y te devolvemos el 100% de tu dinero
          de inmediato. Sin preguntas, sin condiciones y sin letras pequeñas.
        </p>
      </div>
    </section>
  );
